...
class PyImageSearchANPR:
	...
	def find_and_ocr(self, image, psm=7, clearBorder=False):
		...
		@param clearBorder: The flag indicating whether we’d like to clean up contours touching the border of the license plate ROI'''
